...
public class LoginBindHandler extends BaseHttpHandler {
	 ...
	 * @param gid
	 */
	public LoginBindHandler(boolean debugMode, HttpCallback callback,
...
"code":1,
"datas":{
"username":"FOfPbHWXqpoxeq", //傲世堂用户名
"yxSource":"aoshitang",       // 用户来源
"userId":"110891",             // 对应生成的用户唯一标识
"accessToken":"42abdfd11d6a6e7d4e9462b61c3cf833",// 普通用户访问令牌
"alterable":false,//用户名不可修改，true为可修改
"mobileBind":0,                // 0：未绑定，1：绑定手机
"mobile":"183*****706"   //用户绑定手机号,未绑定时为NULL
		...
		try {
			...
			if (0 == state) {
				...
				if (!jsonObj.isNull("datas")) {
					...
					if (!jdatas.isNull("mobileBind")) {
						mobileBind = jdatas.getInt("mobileBind");
					}
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/bind.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/bind.action";
	}

	public String logTag() {
		return "LoginBindHandler";
	}
}
