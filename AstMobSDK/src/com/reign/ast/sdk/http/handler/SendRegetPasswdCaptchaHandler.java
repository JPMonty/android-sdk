 ...
 * 
 */
public class SendRegetPasswdCaptchaHandler extends BaseHttpHandler {
	 ...
	 * @param mobile
	 */
	public SendRegetPasswdCaptchaHandler(boolean debugMode,
	...
	public void prepareRequestOther() {
		...
		setParam("ts", ts + "");
		String ticket = GameUtil.getSendRegetPasswdCaptchaSig(mobile, ts + "");
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/sendForgetCode.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/sendForgetCode.action";
	}

	public String logTag() {
		return "SendRegetPasswdCaptchaHandler";
	}
}
