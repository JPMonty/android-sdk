...
public class ValidateBindCaptchaHandler extends BaseHttpHandler {
	 ...
	 * @param gid
	 */
	public ValidateBindCaptchaHandler(boolean debugMode,
	...
	public void prepareRequestOther() {
		...
		setParam("ts", ts + "");
		String ticket = GameUtil.getValidateGuestBindCode(code, phoneNumber, ts
				+ "");
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/validateBindCode.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/validateBindCode.action";
	}

	public String logTag() {
		return "ValidateGuestBindCaptchaHandler";
	}
}
