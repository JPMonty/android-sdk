 ...
 * 
 */
public class AstLoginHandler extends BaseHttpHandler {
	private static final String TAG = AstLoginHandler.class.getSimpleName();
	 ...
	 * @param gameId
	 */
	public AstLoginHandler(boolean debugMode, HttpCallback callback,
			String userName, String password, String gameId) {
		super(debugMode, callback);
		this.userName = userName;
		this.password = password;
		this.gameId = gameId;
		Logger.d(TAG, "TokenLoginHandler: User:" + userName + " password:"
				+ password + " gameId:" + gameId);
	}
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/astLogin.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/astLogin.action";
	}
