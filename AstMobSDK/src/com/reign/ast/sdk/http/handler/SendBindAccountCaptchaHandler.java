 ...
 * 
 */
public class SendBindAccountCaptchaHandler extends BaseHttpHandler {
	 ...
	 * @param mobile
	 */
	public SendBindAccountCaptchaHandler(boolean debugMode,
	...
	public void prepareRequestOther() {
		...
		setParam("ts", ts + "");
		String ticket = GameUtil.getSendGuestBindSig(mobile, ts + "");
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/sendBindCode.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/sendBindCode.action";
	}

	public String logTag() {
		return "SendGuestBindAccountCaptchaHandler";
	}
}
