...
public class GuestBindHandler extends BaseHttpHandler {
	 ...
	 * @param gid
	 */
	public GuestBindHandler(boolean debugMode, HttpCallback callback,
			String gameId, String mobile, String password, String tmpPlayerId) {
	...
	public void prepareRequestOther() {
		...
		setParam("ts", ts + "");
		String ticket = GameUtil.getGuestBindCode(tmpPlayerId, password,
				mobile, gameId, ts + "");
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/tmpBindMobile.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/tmpBindMobile.action";
	}

	public String logTag() {
		return "GuestBindHandler";
	}
}
