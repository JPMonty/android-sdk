...
public class ValidateRegetPasswdCaptchaHandler extends BaseHttpHandler {
	 ...
	 * @param gid
	 */
	public ValidateRegetPasswdCaptchaHandler(boolean debugMode,
	...
	public void prepareRequestOther() {
		...
		setParam("ts", ts + "");
		String ticket = GameUtil.getValidateForgetPwdCode(code, phoneNumber, ts
				+ "");
	...
	public ResponseEntity parseData(String content) {
		...
		try {
			...
			if (!jsonObj.getJSONObject("datas").isNull("key")) {
				entity.setData(jsonObj.getJSONObject("datas").getString("key"));
			}
	...
	public String getDebugUrl() {
		return "http://testos.mobile.aoshitang.com/v2/validateForgetCode.action";
	}

	public String getReleaseUrl() {
		return "http://mob.aoshitang.com/v2/validateForgetCode.action";
	}

	public String logTag() {
		return "ValidateRegetPasswdCaptchaHandler";
	}
}
